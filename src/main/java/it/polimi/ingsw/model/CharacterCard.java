...
/**
 * The abstract class of the character card.
 * The  cards that require user input have a character state, and is generated by the getCharacterState function
 *
 */
public abstract class CharacterCard {
    ...
    /**
     * The  cards that require user input have a character state.
     * @param context The round controller of the game
     * @param nextState The state from which the card was activated. This the state to return.
     * @return The Character State of the card.
     */
